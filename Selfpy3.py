...
nadya = LINE()
#nadya = LINE("EsHZCymtabEidfVqmi82.Z5LrZkExCjUkk8OyLbDa8G.1OBRg1VO+qgsz65O/eYzJO5m5JU710eGb4Kxvu1/ZT0=")
#nadya = LINE("aspm669@gmail.com","achink1")
...
def helptexttospeech():
    helpTextToSpeech =   "╔══[ T E X T   T O   S P E E C H ]" + "\n" + \
                         ...
                         "╠ cy : Welsh" + "\n" + \
                         "╚══[ Jangan Typo ]" + "\n" + "\n\n" + \
                          "Contoh : say-id Orang Bogor mah Beda Kayak Ada Manis Manisnya Gitu.."
...
def helptranslate():
    helpTranslate =    "╔══[ T R A N S L A T E ]" + "\n" + \
                       ...
                       "╠ he : Hebrew" + "\n" + \
                       "╚══[ Jangan Typo ]" + "\n" + "\n\n" + \
                         "Contoh : tr-id Janda Anak Satu Memang Lebih Menggoda"
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    nadya.sendContact(to, "ucf9951cca797709b8a2bca18941740f2")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "ucf9951cca797709b8a2bca18941740f2"
